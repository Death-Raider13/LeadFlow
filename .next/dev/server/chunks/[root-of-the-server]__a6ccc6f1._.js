...
async function POST(request) {
    try {
        ...
        const decoded = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["firebaseAdminAuth"].verifyIdToken(idToken);
        const expiresIn = SESSION_MAX_AGE * 1000;
        const sessionCookie = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["firebaseAdminAuth"].createSessionCookie(idToken, {
            expiresIn
        });
        ...
        response = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$cookie$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SecureCookieManager"].createSessionCookie(response, sessionCookie, SESSION_MAX_AGE);
        // Apply security headers
        response = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$cookie$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SecureCookieManager"].applySecurityHeaders(response);
        return response;
    } catch (error) {
...
async function DELETE() {
    ...
    response = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$cookie$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SecureCookieManager"].clearAllAuthCookies(response);
    // Apply security headers
    response = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$cookie$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SecureCookieManager"].applySecurityHeaders(response);
    return response;
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a6ccc6f1._.js.map